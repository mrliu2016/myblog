...
<div class="x-body">
    ...
    <!--    <xblock>-->
    <!--        <button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon"></i>批量撤销</button>-->
    <!--        <button class="layui-btn" onclick="x_admin_show('发布消息','./admin-add.html')"><i class="layui-icon"></i>添加-->
    <!--        </button>-->
        ...
        <?php if (!empty($list)): ?>
            <?php foreach ($list as $key => $val): ?>
                <tr>
                    ...
                    <td><?= $val['created'] ?></td>
                    <td class="td-manage">
                        <a title="撤销" onclick="member_del(this,<?= $val['id'] ?>)" href="javascript:;">
                            <i class="iconfont">&#xe718;</i>
                        </a>
                    </td>
                </tr>
