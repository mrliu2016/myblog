        ...
        <div class="s-robot-form_upload">
            ...
            <?php else: ?>
                <input type="hidden" name="img"
                       value="http://userservice.oss-cn-beijing.aliyuncs.com/gift/2018/06/20/14/3410_3765.png">
        ...
        <div class="s-robot-form-details">
            ...
            <p class="c-form_item">
                ...
                <input class="c-input c-form_item-input" placeholder="0-10个字符长度" id="nickName" name="nickName"
                       value="<?= $item['nickName'] ?>" autocomplete="off"/>
            </p>
            <p class="c-form_item">
            ...
            <p class="c-form_item">
                ...
                <span class="c-select-wrap">
                    <select class="c-select u-radius--0 s-robot-form_address-select" name="province" default="0"
                            id="province"
            ...
            <p class="c-form_item">
                ...
                <span class="s-robot-form_receive-wrap">
                        <input class="c-input c-form_item-input s-robot-form_receive" id="receivedGift"
                               name="receivedGift" value="<?= $item['receivedGift'] ?>" autocomplete="off"/>
                    </span>
            </p>
            <p class="c-form_item">
                ...
                <span class="s-robot-form_give-wrap">
                        <input class="c-input c-form_item-input s-robot-form_give" id="sendGift" name="sendGift"
                               value="<?= $item['sendGift'] ?>" autocomplete="off"/>
                    </span>
            </p>
            <p class="c-form_item">
