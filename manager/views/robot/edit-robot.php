    ...
    <form action="" method="post" enctype="multipart/form-data" id="robotForm">
        ...
        <div class="s-robot-form-details">
            <p class="c-form_item">
                ...
                <input type="hidden" value="<?=$item['userId']?>" id="id" name="id">
                <?=$item['userId']?>
            </p>
            <p class="c-form_item">
                <span class="c-form_item-title">昵称：</span>
                <input class="c-input c-form_item-input" placeholder="0-10个字符长度" id="nickName" name="nickName" value="<?=$item['nickName']?>" autocomplete="off"/>
            </p>
            <p class="c-form_item">
            ...
            <p class="c-form_item">
                ...
                <input class="c-input c-form_item-input" id="followees_cnt" name="followees_cnt"  value="<?=$item['followees_cnt']?>" autocomplete="off"/>
            </p>
            <p class="c-form_item">
                <span class="c-form_item-title">粉丝数：</span>
                <input class="c-input c-form_item-input" id="followers_cnt" name="followers_cnt" value="<?=$item['followers_cnt']?>" autocomplete="off"/>
            </p>
            <p class="c-form_item">
                <span class="c-form_item-title">收到礼物：</span>
                <span class="s-robot-form_receive-wrap">
                        <input class="c-input c-form_item-input s-robot-form_receive" id="receivedGift" name="receivedGift" value="<?=$item['receivedGift']?>" autocomplete="off"/>
                    </span>
            </p>
            <p class="c-form_item">
                <span class="c-form_item-title">送出礼物：</span>
                <span class="s-robot-form_give-wrap">
                        <input class="c-input c-form_item-input s-robot-form_give" id="sendGift" name="sendGift"  value="<?=$item['sendGift']?>" autocomplete="off"/>
                    </span>
            </p>
            <p class="c-form_item">
