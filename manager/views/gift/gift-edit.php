            ...
            <div class="s-robot-form_upload">
                ...
                <?php else: ?>
                    ...
                    <img class="s-robot-form_head-img"
                         src="http://userservice.oss-cn-beijing.aliyuncs.com/gift/2018/06/20/14/3410_3765.png"
                         alt="用户头像" id="headImg">
            ...
            <div class="s-robot-form-details">
                ...
                <p class="c-form_item">
                    ...
                    <input class="c-input c-form_item-input" placeholder="0-10个字符长度" name="name" id="name"
                           maxlength="10" value="<?= $item['name'] ?>" autocomplete="off"/>
                </p>
                <p class="c-form_item">
                    ...
                    <span class="s-robot-form_give-wrap">
                        <input class="c-input c-form_item-input s-robot-form_give" name="price" id="price"
                               value="<?= $item['price'] ?>" autocomplete="off"/>
                    </span>
                </p>
                <p class="c-form_item">
