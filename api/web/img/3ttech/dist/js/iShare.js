...
(function (root, factory) {
	...
	function iShare(options) {
		var defaults = {
					title       : options.config.title && document.title,
					url         : options.config.url,
					host        : location.origin || '',
					description : options.config.description && Util.getmeta('description'),
					image       : Util.getimg(),
					WXoptions   : {
						qrcodeW: 120,
						qrcodeH: 120,
	...
	iShare.prototype = (function(){
		var _templates = {
	        ...
	        iShare_tencent     : 'http://share.v.t.qq.com/login.php?c=share&a=index&title={{TITLE}}&url={{URL}}&pic={{IMAGE}}',
