...
<div class="container">
    ...
    <div class="weui-cells weui-cells_radio">
        <h4 class="weui-media-box__title" style="padding-left:15px;">体验金支付</h4>
        <label class="weui-cell weui-check__label" for="x12" id="weixin">
    ...
    $(document).ready(
        ...
        function (){
            ...
            $.ajax({
                type:"get",
                dataType:"json",
                url:"/coupon/valid?unionid="+unionid,
                success:function (data) {
                    ...
                    if(info.code==0){
                        ...
                        for(i=0;i<length;i++){
                            var html='';
                            html+='<label class="weui-cell weui-check__label weui-coupon" for="x1'+data[i].id+'">';
                            html+='<div class="weui-cell__hd"><p>'+data[i].price+'</p></div><div class="weui-cell__ft">';
                            html+='<input type="radio" class="weui-check" name="radio1" id="x1'+data[i].id+'" value="0" data-index="'+data[i].id+'" data-money="'+data[i].price+'">';
                            html+='<span class="weui-icon-checked"></span></div> </label>';
                            $("#weixin").before(html);
                        }
                    }
   ...
   var type=$('input[type=radio]:checked').val();
        if($('#weuiAgree').is(':checked')) {
            if(type==1){
               ...
               var couponid=$('input[type=radio]:checked').data("index");
                $.ajax({
                    type:"post",
                    url:'/payment/wei-xin-js-pay',
                    dadatype:"json",
