...
<div class="container">
    <div class="weui-tab tab-top">
        <div class="weui-navbar">
            <a class="weui-navbar__item weui-bar__item--on" href="#tab0" onclick="main(0)">
                未开始
            </a>
            <a class="weui-navbar__item" href="#tab1" onclick="main(1)">
                进行中
            </a>
            <a class="weui-navbar__item" href="#tab2" onclick="main(2)">
                已结束
            </a>
        </div>
